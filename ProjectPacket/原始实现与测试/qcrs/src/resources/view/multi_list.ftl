...
<@s.form id="multiForm" action="${actionBaseUrl}" method="post" class="form-horizontal" >
	<div class="row">
		<div class="span4">
			<@s.textfield label="用户编码" id="userid" name="userid" autocomplete="off" maxlength="255" />
			<@s.textfield label="用户姓名" id="username" name="username" autocomplete="off" maxlength="255" />
			<@s.textfield label="单实体编码" id="singleid" name="singleid" autocomplete="off" maxlength="255" /> 	
    	</div> 
	</div>
	<div class="row">
    	<div class="span4">
...
<#assign columns={
	...
	"singlename":{"width":"200px","alias":"单实体名称"}
}>
