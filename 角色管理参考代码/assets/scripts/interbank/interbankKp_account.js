$(function() {
	...
	$(document).on('click', '#btn_save', function() {
		...
		var action = "";
		checkAmountV = $("input[name='interbankCntr.maturityAmount']").val();
		...
		if(ifExist){
			action = "/cpms/linkus/capital/interbank/bussiness/t50032InterBank/businessAmend";
		}else{
			action = "/cpms/linkus/capital/interbank/bussiness/t50032InterBank/businessRegister";
		}
			var option = {
				type : "post",
				dataType : "json",
				...
				success : function(data) {
					...
					$("input[name='interbankCntr.contractNo']")
							.val(contractNoV);
				},
				error : function() {
			...
			console.log("付息保存完毕");
		} else if (busiType == "50033") {// ---------------------50030-----------------//
		var ifExist = ifContractExist();	
		if(ifExist){
			action = "/cpms/linkus/capital/interbank/bussiness/t50033InterBank/businessAmend";
		}else{
			action = "/cpms/linkus/capital/interbank/bussiness/t50033InterBank/businessRegister";
		}
//			var $contractNO = $("input[name='interbankCntr.contractNo']");
//			if (!$contractNO.val())
//				action = "/cpms/linkus/capital/interbank/bussiness/t50033InterBank/businessRegister";
//			else
//				action = "/cpms/linkus/capital/interbank/bussiness/t50033InterBank/businessAmend";
			...
			var option = {
				...
				async : false,
				success : function(data) {
					console.log("return:"+data.contractNo);
					contractNoV = data.contractNo;
					$("input[name='interbankCntr.contractNo']")
							.val(contractNoV);
				},
			...
			console.log("开始到期保存  " );
			$("#saveInterbankdq_form").ajaxSubmit(option);
			// console.log("付息保存完毕");
		}
