$(document).on('click','#do30030Save',
	...
	$("select").removeAttr('disabled');
		...
		if(ifContractExist()){
			action = "/cpms/linkus/capital/bill/bussiness/t30030Bill/businessAmend?passFlag=FAIL&approvalOpinion="+approvalOpinion;
		}else{
			action = "/cpms/linkus/capital/bill/bussiness/t30030Bill/businessRegister?passFlag=FAIL&approvalOpinion="+approvalOpinion;
		}
		console.log(action);
		var option = {
			type:"post",
		...
		$("#bill_cntr30030").ajaxSubmit(option);
	});