$(document).on('click','#do30015Save',
	...
	$("toolbarBottom .end,toolbarBottomTips .end").hide();
		...
		if(ifContractExist()){
			action = "/cpms/linkus/capital/bill/bussiness/t30015Bill/businessAmend?passFlag=FAIL&approvalOpinion="+approvalOpinion;
		}else{
			action = "/cpms/linkus/capital/bill/bussiness/t30015Bill/businessRegister?passFlag=FAIL&approvalOpinion="+approvalOpinion;
		}
		console.log(action);
		var option = {
			type:"post",
		...
		$("#bill_cntr30015").ajaxSubmit(option);
	});
