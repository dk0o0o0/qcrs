<div class="easyui-accordion"  style="width:100%;">
	...
	<div title="系统管理">
    	<ul>  		
    		<li><a href="#" title="<@url value="/user"/>" class="view"><i class="circle-full"></i><span>用户管理</span></a></li>
    		...
    		<li><a href="#" title="<@url value="/dept"/>" class="view"><i class="circle-full"></i><span>机构管理</span></a></li>
  		</ul>
	</div>	
</div>
